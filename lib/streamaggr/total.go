...
func newTotalAggrState(interval, stalenessInterval, delay time.Duration, resetTotalOnFlush, keepFirstSample bool, ignoreOutOfOrderSamples bool, nowFunc func() uint64, ms *metrics.Set) *totalAggrState {
